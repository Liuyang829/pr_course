...
def loadDataSet(intX, intY):
    file_data1 = np.loadtxt(r'D:\迅雷下载\PR_Course-master\PR_Course-master\expData\genderdata\MALE.txt', delimiter='\t')

    file_data2 = np.loadtxt(r'D:\迅雷下载\PR_Course-master\PR_Course-master\expData\genderdata\FEMALE.txt', delimiter='\t')
